...
\caption{\label{fig:5} (Left) The black circles represent the $\mathbf{E}$-plane radiation pattern data at 5.967 GHz, and the black line represnts our 3D MEEP simulation of $\mathbf{E}$-plane radiation pattern.  (Right) The black crosses represent the $\mathbf{H}$-plane radiation pattern data at 5.85 GHz, and the black line represents our 3D MEEP simulation of $\mathbf{H}$-plane radiation pattern.}
\end{figure}
